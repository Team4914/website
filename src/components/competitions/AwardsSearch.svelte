<script lang="ts">
    ...
    const years: number[] = Array.from({length: maxYear - minYear + 1}, (x, i) => maxYear - i);
</script>
...
<div class="join">
    ...
    <button on:click={onEnter} class="btn join-item bg-blue-700 hover:bg-blue-600">Search</button>
</div>