...
<div class="navbar bg-base-100 sticky top-0"> <!-- Container -->
  <div class="navbar-start">
    ...
    <label for="sidebar" aria-label="open sidebar" class="btn btn-ghost swap swap-rotate z-1000 xl:hidden">
      <!-- hamburger icon -->
    ...
    <!-- Website Title -->
    <a class="btn btn-ghost normal-case text-xl align-top" href="/">
      <img src="https://cdn.discordapp.com/attachments/1122723830973075506/1124411188294463568/logo.png" class="h-16" alt="VPCI Robotics Logo">
